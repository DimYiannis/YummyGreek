        ...
        place-self-center w-screen h-fit">
            ...
            <form class="mb-6">
                ...
                <h2 class="mb-1 font-semibold">
                    Log in to Savor Exclusive Restaurant Perks: Access Your Flavorful Dashboard!
                    <br>
                ...
                <button  class="bg-white w-full rounded-3xl 
                    m-4 text-black h-10 border-2 border-stone-300
                    hover:border-black font-semibold ">
                    Log in
                </button>
